...
| Taunt and what a drawn mob does | A drawn mob has its target cleared every tick of the hold and is pathed to the impact, so for that duration it walks to the spot and fights nothing, including whoever is standing on it. It picks its own fights again the moment the hold is handed back |
...
| Daze and wandering | A dazed mob has its target cleared every tick of the hold and is given no destination of its own, so vanilla's own wandering takes over and the mob drifts rather than standing still |
