...
It is placed through the same permission gate fire patches use, so an arrow cannot drop a charge inside spawn protection or outside the world border, and only ever into air.
