---
name: pr
description: Create a PR for the minecraft-more-arrows repo using a git worktree branched from latest main. Use for final commit, push, and PR flow.
---
...
8. Create PR with a body file to preserve markdown formatting and avoid shell interpolation issues:
	...
	- Create PR: `gh pr create --repo grabartley/minecraft-more-arrows --base main --head <branch-name> --title "<title>" --body-file .claude/tmp/pr-body.md`
	- If updating an existing PR body, use: `gh pr edit <pr-number> --repo grabartley/minecraft-more-arrows --body-file .claude/tmp/pr-body.md`
...
9. After merge, clean up: `git worktree remove ./.claude/worktrees/more-arrows-<branch-name>`
...
- Worktree path: `./.claude/worktrees/more-arrows-<branch-name>`
