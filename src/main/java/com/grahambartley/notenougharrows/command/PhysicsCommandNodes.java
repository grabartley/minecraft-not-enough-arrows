...
public final class PhysicsCommandNodes {
  ...
  public static String rejectionKey(final GravityExclusions.Outcome outcome) {
    return switch (outcome) {
      case ALREADY_PRESENT -> "command.not-enough-arrows.exclusions.already_present";
      case NOT_PRESENT -> "command.not-enough-arrows.exclusions.not_present";
      case LIST_FULL -> "command.not-enough-arrows.exclusions.full";
      default -> "command.not-enough-arrows.exclusions.invalid";
    };
  }
