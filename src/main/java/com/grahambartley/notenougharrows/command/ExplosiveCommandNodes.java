...
public final class ExplosiveCommandNodes {
  ...
  private static NotEnoughArrowsConfig changeTier(
      final NotEnoughArrowsConfig current,
      final Function<ExplosiveArrowConfig, ExplosiveTierConfig> reader,
      final TierWriter writer,
  ...
  private static NotEnoughArrowsConfig change(
      final NotEnoughArrowsConfig current, final UnaryOperator<ExplosiveArrowConfig> change) {
