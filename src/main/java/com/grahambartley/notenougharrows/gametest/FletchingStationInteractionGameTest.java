...
public final class FletchingStationInteractionGameTest implements FabricGameTest {
  ...
  private static final String ENABLE_STATION =
      "notenougharrows config fletching stationenabled true";
  private static final String DISABLE_STATION =
      "notenougharrows config fletching stationenabled false";
  private static final String RESET_CONFIG = "notenougharrows config reset";
