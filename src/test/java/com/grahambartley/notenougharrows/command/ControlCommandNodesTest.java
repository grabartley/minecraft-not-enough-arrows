...
class ControlCommandNodesTest {
  ...
  @CsvSource({
    "notenougharrows config control frost freezeticksperhit 0,          true",
    "notenougharrows config control frost freezeticksperhit 1200,       true",
    "notenougharrows config control frost freezeticksperhit -1,         false",
    "notenougharrows config control frost freezeticksperhit 1201,       false",
    ...
    "notenougharrows config control targeting dazedurationticks 6000,   true",
    "notenougharrows config control targeting dazedurationticks 6001,   false",
