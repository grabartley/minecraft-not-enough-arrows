...
class EnderCommandNodesTest {
  ...
  @CsvSource({
    ...
    "morearrows config ender pearlarrivaldamage 0.0,       true",
    "morearrows config ender pearlarrivaldamage 20.0,      true",
    "morearrows config ender pearlarrivaldamage -0.5,      false",
    "morearrows config ender pearlarrivaldamage 20.5,      false",
