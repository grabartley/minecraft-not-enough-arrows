...
class NotEnoughArrowsEmiPluginTest {
  ...
  void handsEmiOneInfoRecipePerArrowInRegistrationOrder() {
    ...
    inOrder
        .verify(registry)
        .addRecipe(byRecipeId.get(Identifier.of(NotEnoughArrows.MOD_ID, "info/rope_arrow")));
    inOrder
        .verify(registry)
        .addRecipe(byRecipeId.get(Identifier.of(NotEnoughArrows.MOD_ID, "info/tnt_arrow")));
