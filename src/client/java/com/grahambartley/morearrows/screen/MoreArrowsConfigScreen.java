...
import com.grahambartley.morearrows.network.ServerConfigUpdateSender;
...
public final class MoreArrowsConfigScreen extends Screen {
  public static final String TITLE_KEY = "config.more-arrows.title";
  public static final String RESET_KEY = "config.more-arrows.reset";
  public static final String SAVE_FAILED_KEY = "config.more-arrows.save.failed";
  ...
  public static MoreArrowsConfigScreen create(final Screen parent) {
    return new MoreArrowsConfigScreen(
        parent,
  ...
  protected void init() {
    ...
    for (final ConfigSection<MoreArrowsConfig> section : ServerConfigOptions.sections()) {
  ...
  private void resetToDefaults() {
    if (access.editable()) {
      serverDraft.set(MoreArrowsConfig.defaults());
    }
